...
program
  ...
  .option('-c, --channel <channel>', 'Comma-separated list of channel codes', '')
  .option('-e, --exclude <exclude>', 'Comma-separated list of channel codes to be excluded', '')
...
function parseIndex() {
  ...
  playlists = utils.filterPlaylists(playlists, config.channel, config.exclude)
